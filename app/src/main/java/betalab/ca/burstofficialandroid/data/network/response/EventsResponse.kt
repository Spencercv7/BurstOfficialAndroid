...
data class EventsResponse(
    ...
    fun toEntry(): EventEntry {
        return EventEntry(allDay,attendees, eventId, hostName,host, images, location, description, name, repeat, tags, start, end, attendeeCount, coverImage, mainImage)
    }
